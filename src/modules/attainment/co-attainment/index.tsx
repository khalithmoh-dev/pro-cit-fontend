...
import styles from "./attainment.module.css";
...
import useAttainmentStore from "../../../store/attainmentStore";

const tabs = ["S"]

const CoAttainment: React.FC = (): JSX.Element => {
    ...
    const { getSubjectWiseCoAttainment, getExamWiseCoAttainment } = useAttainmentStore();

    const generateClickHandler = useCallback(() => {
        if (selectedSubject && !selectedExam) {
            getSubjectWiseCoAttainment(selectedSubject);
        } else if (selectedSubject && selectedExam) {
            getExamWiseCoAttainment(selectedExam);
        }
    }, [getExamWiseCoAttainment, getSubjectWiseCoAttainment, selectedExam, selectedSubject]);
    ...
    return (
        <div className={styles.container}>
            <TableControlBox tableName="CO attainment">
