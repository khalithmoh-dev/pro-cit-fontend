...
import style from "./student-fees-pay.module.css";
...
import StudentPaymentTableComponent from "./student-fees-payment-view/index.tsx";

const StudentFeesPaymentViewPage = () => {
    ...
    return (
        <div className={style.container}>
            <TableControlBox tableName="Fee Payment History" onRefresh={onRefresh} showCacheMessage={showCacheMessage}>
...
export default StudentFeesPaymentViewPage;
