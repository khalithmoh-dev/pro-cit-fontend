...
interface PropsIF {
    installmentFineReport: boolean;
    setInstallmentFineReport?: (open: boolean) => void;
...
const InstallmentFineReportModal: React.FC<PropsIF> = ({ installmentFineReport, setInstallmentFineReport, selectedStudent }) => {



    const { Department, ParentHead }: any = useDepartmentStore();
    ...
    const handleDialogClose = () => {
        if (setInstallmentFineReport) {
            setInstallmentFineReport(false);
        }
    };
...
export default InstallmentFineReportModal;
