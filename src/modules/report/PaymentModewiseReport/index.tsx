...
interface PropsIF {
    ...
    setPaymentReport?: (open: boolean) => void;
...
const PaymentModewiseReport: React.FC<PropsIF> = ({ paymentReport, setPaymentReport, selectedStudent }) => {
    ...
    return (
        <div>
            ...
            >
                ...
                Payment Modewise Scholarship Headwise Collection Report
