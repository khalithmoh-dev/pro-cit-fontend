...
interface PropsIF {
    ...
    setStudentReportModal?: (open: boolean) => void;
...
const StudentPaymentFeeReportModal: React.FC<PropsIF> = ({ studentReportModal, setStudentReportModal, selectedStudent }) => {
    ...
    const handleDialogClose = () => {
        if (setStudentReportModal) {
            setStudentReportModal(false);
        }
    };
        ...
        <div>
            ...
            >
                <div className={style.GenerateChallanheader}>
                    Student Payment Categorywise Yearwise Fee Report
                                                ...
                                                <div>
                                                    ...
                                                    <div className={style.collectionColumn} style={{ fontSize: "14px" }}>
                                                        <div style={{ fontSize: "14px" }}>
                                                            <div style={{ gap: "8px", display: "flex" }}><input
                                                                type="checkbox"
                                                                onChange={() => toggleAll('csAndEng')}
                                                                checked={selections.csAndEng.every(value => value)} /> <span>Computer Science & Engineering</span></div>
                                                            <div>
                                                                <div style={{ gap: "8px", display: "flex" }}>
                                                                    <input
                                                                        type="checkbox"
                                                                        checked={selections.csAndEng[0]}
                                                                        onChange={() => handleChange('csAndEng', 0)} /> First Year
                                                                </div>
                                                                <div style={{ gap: "8px", display: "flex" }}> <input
                                                                    type="checkbox"
                                                                    checked={selections.csAndEng[1]}
                                                                    onChange={() => handleChange('csAndEng', 1)} /> Second Year</div>
                                                                <div style={{ gap: "8px", display: "flex" }}><input
                                                                    type="checkbox"
                                                                    checked={selections.csAndEng[2]}
                                                                    onChange={() => handleChange('csAndEng', 2)} /> Third Year</div>
                                                                <div style={{ gap: "8px", display: "flex" }}>
                                                                    <input
                                                                        type="checkbox"
                                                                        checked={selections.csAndEng[3]}
                                                                        onChange={() => handleChange('csAndEng', 3)} /> Fourth Year
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                            ...
                                                            <div>
                                                                <div style={{ gap: "8px", display: "flex" }}>
                                                                    <input
                                                                        type="checkbox"
                                                                        checked={selections.csAndEng[0]}
                                                                        onChange={() => handleChange('csAndEng', 0)} /> cash
                                                                </div>
                                                                <div style={{ gap: "8px", display: "flex" }}> <input
                                                                    type="checkbox"
                                                                    checked={selections.csAndEng[1]}
                                                                    onChange={() => handleChange('csAndEng', 1)} />  online</div>
                                                                <div style={{ gap: "8px", display: "flex" }}> <input
                                                                    type="checkbox"
                                                                    checked={selections.csAndEng[1]}
                                                                    onChange={() => handleChange('csAndEng', 1)} />  dd</div>
                                                                <div style={{ gap: "8px", display: "flex" }}> <input
                                                                    type="checkbox"
                                                                    checked={selections.csAndEng[1]}
                                                                    onChange={() => handleChange('csAndEng', 1)} />  cheque</div>
                                                                <div style={{ gap: "8px", display: "flex" }}> <input
                                                                    type="checkbox"
                                                                    checked={selections.csAndEng[1]}
                                                                    onChange={() => handleChange('csAndEng', 1)} />   pos</div>
                                                                <div style={{ gap: "8px", display: "flex" }}> <input
                                                                    type="checkbox"
                                                                    checked={selections.csAndEng[1]}
                                                                    onChange={() => handleChange('csAndEng', 1)} />   neft</div>
                                                                <div style={{ gap: "8px", display: "flex" }}> <input
                                                                    type="checkbox"
                                                                    checked={selections.csAndEng[1]}
                                                                    onChange={() => handleChange('csAndEng', 1)} />  wallet</div>
                                                                <div style={{ gap: "8px", display: "flex" }}> <input
                                                                    type="checkbox"
                                                                    checked={selections.csAndEng[1]}
                                                                    onChange={() => handleChange('csAndEng', 1)} />  Intermission</div>
                                                                <div style={{ gap: "8px", display: "flex" }}> <input
                                                                    type="checkbox"
                                                                    checked={selections.csAndEng[1]}
                                                                    onChange={() => handleChange('csAndEng', 1)} />  SCC</div>
                                                                <div style={{ gap: "8px", display: "flex" }}> <input
                                                                    type="checkbox"
                                                                    checked={selections.csAndEng[1]}
                                                                    onChange={() => handleChange('csAndEng', 1)} />  J V</div>
...
export default StudentPaymentFeeReportModal;
