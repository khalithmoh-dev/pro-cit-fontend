...
interface PropsIF {
    ...
    setConcessionDialogOpen?: (open: boolean) => void;
...
const DailyCollectionReportModal: React.FC<PropsIF> = ({ ConcessionDialogOpen, setConcessionDialogOpen, selectedStudent }) => {
    ...
    const { getReceiptSeries, ReceiptSeriesget, Department, getDepartment, PaymentMode, getPaymentMode, getFeeHead, FeeHead, getReportData, reportData }: any = useDepartmentStore();
    ...
    const handleSeriesChange = (e: { target: { value: React.SetStateAction<string>; }; }) => {
    ...
    const handleApplyClick = async (e: React.FormEvent) => {
        ...
        const result = await getReportData(startDate, endDate, selectedYear, selectedSeries, selectedModes, false);
        handleFilterClickclose();

        if (result) {
            console.log('Report data fetched successfully:', result); // Use 'result' for the fetched data
        }
    };


    const groupedData = reportData.reduce((acc: any, data: any) => {
        if (!acc[data.mode]) {
            acc[data.mode] = {
                mode: data.mode,
                totalFee: 0,  // Sum of all total_fee (if available)
                totalPaidAmount: 0, // Sum of all paid_amount
            };
        }
                ...
                <DialogBody>
                            ...
                            >
                                        ...
                                        <div style={{ display: "flex", gap: "15px" }}>
                                            <div style={{ width: '100%' }}>
                                                ...
                                                >
                                                    ...
                                                    <option value="29" id="acaYr29">2001-02</option>
                                                    <option value="28" id="acaYr28">2002-03</option>
                                                    <option value="27" id="acaYr27">2003-04</option>
                                                    <option value="26" id="acaYr26">2004-05</option>
                                                    <option value="25" id="acaYr25">2005-06</option>
                                                    <option value="24" id="acaYr24">2006-07</option>
                                                    <option value="16" id="acaYr16">2007-08</option>
                                                    <option value="17" id="acaYr17">2008-09</option>
                                                    <option value="18" id="acaYr18">2009-10</option>
                                                    <option value="19" id="acaYr19">2010-11</option>
                                                    <option value="20" id="acaYr20">2011-12</option>
                                                    <option value="21" id="acaYr21">2012-13</option>
                                                    <option value="22" id="acaYr22">2013-14</option>
                                                    <option value="23" id="acaYr23">2014-15</option>
                                                    <option value="1" id="acaYr1">2015-16</option>
                                                    <option value="2" id="acaYr2">2016-17</option>
                                                    <option value="3" id="acaYr3">2017-18</option>
                                                    <option value="4" id="acaYr4">2018-19</option>
                                                    <option value="5" id="acaYr5">2019-20</option>
                                                    <option value="6" id="acaYr6">2020-21</option>
                                                    <option value="7" id="acaYr7">2021-22</option>
                                                    <option value="8" id="acaYr8">2022-23</option>
                                                    <option value="9" id="acaYr9">2023-24</option>
                                                    <option value="10" id="acaYr10">2024-25</option>
                                                    <option value="11" id="acaYr11">2025-26</option>
                                                    <option value="12" id="acaYr12">2026-27</option>
                                                    <option value="13" id="acaYr13">2027-28</option>
                                                    <option value="14" id="acaYr14">2028-29</option>
                                                    <option value="15" id="acaYr15">2029-30</option>
                                                </select>
                                            </div>
                                            <div style={{ width: '100%' }}>
                                            ...
                                            <div style={{ width: '100%' }}><label style={{ fontSize: "14px", fontWeight: "500" }}>Order By</label>
                                            ...
                                            <div style={{ width: '100%' }}>
                                                <label style={{ fontSize: "14px", fontWeight: "500" }}>Payment Source</label>
                                ...
                                <div className={style?.inputError}>
                                    <div>
                                        ...
                                        <div style={{ display: "flex", gap: "15px" }}>
                                            <div style={{ width: '100%' }}>
                                                <label style={{ fontSize: "14px", fontWeight: "500" }}>Receipt Generated By</label>
                                                <select className={style.academySelect} id="facultyAccessList"><option value="">Select Faculty</option><option value="11211">Thimmaiah A G</option><option value="12143">Mr Devaiah K S</option><option value="12185">Ms Meera h J</option><option value="12187">Mr Dilan K B</option><option value="12192">Ms Bollamma A S</option></select>
                                            </div>
                                            <div style={{ width: '100%' }}>
                                                <label style={{ fontSize: "14px", fontWeight: "500" }}>Display Canceled Receipts</label>
                                                <select className={style.academySelect}>
                                                    <option>
                                                        Yes
                                                    </option>
                                                    <option>
                                            ...
                                            <div style={{ width: '100%' }}>
                                                ...
                                                <select className={style.academySelect} id="instituteSelectBox"><option value="">Select Institute</option><option value="954">CIT</option></select>                                            </div>
                                            <div style={{ width: '100%' }}>
                                                <label style={{ fontSize: "14px", fontWeight: "500" }}>Receipt Series</label>
                                                <select
                                                    id="receiptSeriesList"
                                                    value={selectedSeries} // Bind the value to state
                                ...
                                <div className={style.collection}>
                                    ...
                                    <div style={{ padding: "9px" }}>
                                        <div className={style.collectionColumn}>
                                            <label>Head Groups</label>
                                            <select
                                                className={style.academySelect}
                                                name="ConcessionType"
                                            >
                                        ...
                                        <div style={{ gap: "10px", display: "flex" }}> <button style={{ backgroundColor: "#0465ac", border: "none", color: "white", padding: "8px" }} onClick={handleApplyClick} >Apply</button>
                                            <button style={{ border: "2px solid #0465ac",backgroundColor: "white", color: "#0465ac", padding: "8px" }} onClick={handleFilterClickclose}>
                                                Cancel
                                            </button>
                                        </div>
                                    </div>
                    ...
                    {reportData.length === 0 ? (
                        ...
                        <div style={{ padding: '20px', backgroundColor: 'white' }}>
                            ...
                            <div style={{ padding: '7px', border: '1px solid #ddd', display: "flex", justifyContent: 'center', fontSize: "13px", fontWeight: "600", backgroundColor: "#f5f7fb" }}>Start Date : 2024-12-12 | End Date : 2024-12-13 | Academic Year : 2008-09 | Order By: receiptNumber | Payment Source: challan | Generated By: Thimmaiah A G | Display Canceled Receipts: Yes | Payement Mode: cash</div>
                            <table className={style.reportTable} style={{ width: '100%', borderCollapse: 'collapse', overflow: "scroll", display: "block" }} ref={pdfRef} >
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th style={{ padding: '8px', border: '1px solid #ddd', textAlign: 'right', fontSize: "13px", fontWeight: "600", backgroundColor: "#f5f7fb" }}>Institute Short Name</th>
                                        <th style={{ padding: '8px', border: '1px solid #ddd', textAlign: 'right', fontSize: "13px", fontWeight: "600", backgroundColor: "#f5f7fb" }}>Date</th>
                                        ...
                                        <th style={{ padding: '8px', border: '1px solid #ddd', textAlign: 'right', fontSize: "13px", fontWeight: "600", backgroundColor: "#f5f7fb" }}>Stream</th>
                                        <th style={{ padding: '8px', border: '1px solid #ddd', textAlign: 'right', fontSize: "13px", fontWeight: "600", backgroundColor: "#f5f7fb" }}>Group/ Year</th>
                                        <th style={{ padding: '8px', border: '1px solid #ddd', textAlign: 'right', fontSize: "13px", fontWeight: "600", backgroundColor: "#f5f7fb" }}>Receipt Generated By	</th>
                                        <th style={{ padding: '8px', border: '1px solid #ddd', textAlign: 'right', fontSize: "13px", fontWeight: "600", backgroundColor: "#f5f7fb" }}>Receipt Amount	</th>
                                        ...
                                        <th style={{ padding: '8px', border: '1px solid #ddd', textAlign: 'right', fontSize: "13px", fontWeight: "600", backgroundColor: "#f5f7fb" }}>Advance</th>
                                        <th style={{ padding: '8px', border: '1px solid #ddd', textAlign: 'right', fontSize: "13px", fontWeight: "600", backgroundColor: "#f5f7fb" }}>Refund</th>
                                        <th style={{ padding: '8px', border: '1px solid #ddd', textAlign: 'right', fontSize: "13px", fontWeight: "600", backgroundColor: "#f5f7fb" }}>Installment Fine	</th>
                                        <th style={{ padding: '8px', border: '1px solid #ddd', textAlign: 'right', fontSize: "13px", fontWeight: "600", backgroundColor: "#f5f7fb" }}>Consumed Previous Excess Amount	</th>
