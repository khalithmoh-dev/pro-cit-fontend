...
interface PropsIF {
    yearHeadwiseReport: boolean;
    setYearHeadwiseReport?: (open: boolean) => void;
...
const YearScholarshipHeadwiseReportModal: React.FC<PropsIF> = ({ yearHeadwiseReport, setYearHeadwiseReport, selectedStudent }) => {
    ...
    const handleDialogClose = () => {
        if (setYearHeadwiseReport) {
            setYearHeadwiseReport(false);
        }
    };
    ...
    return (
        <div>
            ...
            >
                ...
                Yearwise Scholarship Headwise Report
...
export default YearScholarshipHeadwiseReportModal;
