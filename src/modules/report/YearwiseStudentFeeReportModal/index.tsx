...
interface PropsIF {
    FeeReportModal: boolean;
    setFeeReportModal?: (open: boolean) => void;
...
const YearwiseStudentFeeReportModal: React.FC<PropsIF> = ({ FeeReportModal, setFeeReportModal, selectedStudent }) => {




    const { getParentHead, ParentHead, getDepartment, Department, FeeHead, PaymentMode }: any = useDepartmentStore();
                        ...
                        {dropdownOpen && (
                            ...
                            >
                                <div className={style?.inputError}>
                                    <div>
                                        ...
                                        <div style={{ display: "flex", gap: "50px" }}>
                                            ...
                                            <div style={{width:"100%"}}><label style={{ fontSize: "14px", fontWeight: "500" }}>Select month and year</label>
                                        ...
                                        <div style={{ display: "flex", gap: "50px" }}>
                                            <div style={{width:"100%"}}>
                                                ...
                                                >
                                                  ...
                                                  {FeeHead?.map((data:any) => (
                                                    <option>{data?.head_group_name}</option>
                                                  ))}
                                                </select>
                                            </div>
                                            <div style={{width:"100%"}}>
                                            ...
                                            <div style={{width:"100%"}}>
                                                <label style={{ fontSize: "14px", fontWeight: "500" }}>Payment Category</label>
                                                <select
                                                    className={style.academySelect}
                                                    name="ConcessionType"
                                                >
                                                    ...
                                                    {PaymentMode?.map((data:any) => (
                                                        <option>{data.modeName}</option>
                                                    ))}
                                                </select>
                                            </div>
                                        </div>
                                    </div>
                                    <div style={{ gap: "10px", display: "flex", justifyContent: "end" }}> <button style={{ backgroundColor: "#0465ac", color: "white", padding: "8px", border: "none" }} >Apply</button>
                                ...
                                <div style={{ display: "flex", gap: "50px" }}>
                                    ...
                                    <div style={{width:"100%"}}>
                                        <label style={{ fontSize: "14px", fontWeight: "500" }}>Previous Year Upto</label>
                                        <select
                                            className={style.academySelect}
                                            name="ConcessionType"
                                        >
...
export default YearwiseStudentFeeReportModal;
