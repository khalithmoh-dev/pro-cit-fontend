...
interface PropsIF {
    facilityReportModal: boolean;
    setFacilityReportModal?: (open: boolean) => void;
...
const FacilitywiseBalanceReportModal: React.FC<PropsIF> = ({ setFacilityReportModal, facilityReportModal, selectedStudent }) => {



    const [selectedDepartment, setSelectedDepartment] = useState('');
    const [selectFacility , setSelectFacility ] = useState('')
    console.log(selectFacility,"selectedDepartmentselectedDepartment")
    ...
    const handleSelectFacility = (e:any) => {
    ...
    const { Department, getDepartment,getFacility,Facility }: any = useDepartmentStore();
    ...
    const handleApplyClick = async (e: React.FormEvent) => {
        ...
        const result = await getFacility(selectedYear,selectFacility, false);
                                ...
                                <div className={style?.inputError}>
                                    <div>
                                        ...
                                        <div style={{width:"100%"}}>
                                            ...
                                            <div  style={{width:"100%"}}><label style={{ fontSize: "14px", fontWeight: "500" }}>Facility <span style={{ color: 'red' }}>*</span></label>
                                            <select
                                                    className={style.academySelect}
                                                    name="ConcessionType"
                                            ...
                                            <div style={{width:"100%"}}>
                                                <label style={{ fontSize: "14px", fontWeight: "500" }}>Select Display Type</label>
                                                <select
                                                    className={style.academySelect}
                                                    name="ConcessionType"
                                                >
                                            ...
                                            <div style={{width:"100%"}}>
                                                <label style={{ fontSize: "14px", fontWeight: "500" }}>Semester</label>
                                                <select
                                                    className={style.academySelect}
                                                    name="ConcessionType"
                                                >
                            ...
                            <table className={style.reportTable} style={{ width: '100%', borderCollapse: 'collapse',overflow:"scroll", display:"block" }}  ref={pdfRef} >
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th style={{ padding: '8px', border: '1px solid #ddd', textAlign: 'right', fontSize: "13px", fontWeight: "600", backgroundColor: "#f5f7fb" }}>Access</th>
                                        ...
                                        <th style={{ padding: '8px', border: '1px solid #ddd', textAlign: 'right', fontSize: "13px", fontWeight: "600", backgroundColor: "#f5f7fb" }}>Father Full Name</th>
                                        <th style={{ padding: '8px', border: '1px solid #ddd', textAlign: 'right', fontSize: "13px", fontWeight: "600", backgroundColor: "#f5f7fb" }}>Admission No.	</th>
                                        ...
                                        <th style={{ padding: '8px', border: '1px solid #ddd', textAlign: 'right', fontSize: "13px", fontWeight: "600", backgroundColor: "#f5f7fb" }}>Gender</th>
                                        <th style={{ padding: '8px', border: '1px solid #ddd', textAlign: 'right', fontSize: "13px", fontWeight: "600", backgroundColor: "#f5f7fb" }}>Mobile No</th>
                                        <th style={{ padding: '8px', border: '1px solid #ddd', textAlign: 'right', fontSize: "13px", fontWeight: "600", backgroundColor: "#f5f7fb" }}>Total</th>
                                ...
                                <tbody>
                                {Facility?.length > 0 ? (
                                        Facility.map((data: any, index: any) => {
                                        ...
                                        return (
                                            <tr key={index}>
                                                ...
                                                <td style={{ padding: '8px', border: '1px solid #ddd', textAlign: 'right', fontSize: "13px" }}>
                                                {data.student_id.accessforWebsite ? 'Granted' : 'Not Granted'}
                                                </td>
                                                <td style={{ padding: '8px', border: '1px solid #ddd', textAlign: 'right', fontSize: "13px" }}>
                                                {data?.student_id?.firstName}
                                                </td>
                                                <td style={{ padding: '8px', border: '1px solid #ddd', textAlign: 'right', fontSize: "13px" }}>
                                                {data?.student_id?.lastName}
                                                </td>
                                                <td style={{ padding: '8px', border: '1px solid #ddd', textAlign: 'right', fontSize: "13px" }}>
                                                ...
                                                <td style={{ padding: '8px', border: '1px solid #ddd', textAlign: 'right', fontSize: "13px" }}>
                                                    ...
                                                    {data?.student_id?.gender}
                                                </td>
                                                <td style={{ padding: '8px', border: '1px solid #ddd', textAlign: 'right', fontSize: "13px" }}>
                                                    {data?.student_id?.contactNumber}
                                                </td>
                                                <td style={{ padding: '8px', border: '1px solid #ddd', textAlign: 'right', fontSize: "13px" }}>
...
export default FacilitywiseBalanceReportModal;
