...
interface PropsIF {
    scholarshipFreeshipReport: boolean;
    setScholarshipFreeshipReport?: (open: boolean) => void;
...
const NumberGovernmentScholarshipFreeshipReportModal: React.FC<PropsIF> = ({ setScholarshipFreeshipReport, scholarshipFreeshipReport, selectedStudent }) => {
    ...
    const handleDialogClose = () => {
        if (setScholarshipFreeshipReport) {
            setScholarshipFreeshipReport(false);
        }
    };
    ...
    return (
        <div>
            <Dialog
                isOpen={scholarshipFreeshipReport}
            ...
            >
                <div className={style.GenerateChallanheader}>
                    Number of Student(s) benefited by Government Scholarship & Freeship Report
...
export default NumberGovernmentScholarshipFreeshipReportModal;
