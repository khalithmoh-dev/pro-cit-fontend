...
interface PropsIF {
    studentScholarshipReport: boolean;
    setStudentScholarshipReport?: (open: boolean) => void;
...
const StudentScholarshipFreeshipReportModal: React.FC<PropsIF> = ({ studentScholarshipReport, setStudentScholarshipReport, selectedStudent }) => {
    ...
    const handleDialogClose = () => {
        if (setStudentScholarshipReport) {
            setStudentScholarshipReport(false);
        }
    };
    ...
    return (
        <div>
            <Dialog
                isOpen={studentScholarshipReport}
            ...
            >
                <div className={style.GenerateChallanheader}>
                    Student(s) benefited by Government Scholarship & Freeship Report
                                ...
                                <div className={style?.inputError}>
                                    <div>
                                        ...
                                        <div style={{ display: "flex", gap: "77px" }}>
                                            ...
                                            <div>
                                                <label style={{ fontSize: "14px", fontWeight: "500" }}>Admission Types</label>
                                                <select
                                                    className={style.academySelect}
                                                    name="ConcessionType"
                                                >
                                                    <option value="">Select Admission Types</option>
...
export default StudentScholarshipFreeshipReportModal;
