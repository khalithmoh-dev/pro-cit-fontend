...
interface PropsIF {
    ...
    setDiscrepancyReport?: (open: boolean) => void;
...
const DiscrepancyReportModal: React.FC<PropsIF> = ({ discrepancyReport, setDiscrepancyReport, selectedStudent }) => {



    const { Department,  }: any = useDepartmentStore();
    ...
    const handleDialogClose = () => {
        if (setDiscrepancyReport) {
            setDiscrepancyReport(false);
        }
    };
                                ...
                                <div className={style?.inputError}>
                                    <div>
                                        ...
                                        <div style={{ display: "flex", gap: "150px"  }}>
                                            ...
                                            <div style={{ width: "100%" }}>
                                                <label style={{ fontSize: "14px", fontWeight: "500" }}>Select Group</label>
                                                <select
                                                    className={style.academySelect}
                                                    name="ConcessionType"
                                                >
