...
import StudentCategoryRoutes from '../StudentCategoryRoutes';
import InstallMentRoutesRoutes from '../InstallMentRoutes';
import StudentFeePaymentRoutes from '../StudentFeePaymentRoutes';
import QuickCollectRoutes from '../QuickCollectRoutes';
